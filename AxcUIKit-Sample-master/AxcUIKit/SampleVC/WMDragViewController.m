...
#import "WMDragViewController.h"

#import "GlobalView.h"//单例全局滑动按钮
#import "PopoverView.h" //点击弹出框

@interface WMDragViewController ()
{
    UISwitch * Gswitch; //开关
}
...
@implementation WMDragViewController
...
//    _globalView.isKeepBounds = YES;
    ...
    __block WMDragViewController *blockSelf = self;
