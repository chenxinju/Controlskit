...
- (instancetype)initWithTitle:(nullable NSString *)title
    ...
    [self.buttonLeft setTitleColor:UIColorFromRGB(0x1F6AE5) forState:UIControlStateNormal];
    ...
    [self.buttonRight setTitleColor:UIColorFromRGB(0x1F6AE5) forState:UIControlStateNormal];
