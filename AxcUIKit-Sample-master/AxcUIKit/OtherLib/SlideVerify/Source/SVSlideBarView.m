...
- (void)failedStyle {
    ...
    scrollBackView.backgroundColor = RGB(250, 225, 225);
    slideBar.backgroundColor = RGB(244, 124, 124);
...
- (void)successfulStyle {
    ...
    scrollBackView.backgroundColor = RGB(210, 244, 240);
    slideBar.backgroundColor = RGB(88, 203, 186);
    self.layer.borderColor = slideBar.backgroundColor.CGColor;
    self.layer.shadowColor = self.layer.borderColor;
}
...
- (void)defaultStyle {
    ...
    scrollBackView.backgroundColor = RGB(210, 230, 250);
    slideBar.backgroundColor = RGB(38, 148, 248);
    self.layer.borderColor = slideBar.backgroundColor.CGColor;
    self.layer.shadowColor = self.layer.borderColor;
