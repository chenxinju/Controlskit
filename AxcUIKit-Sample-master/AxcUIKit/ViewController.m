...
//        [Group1 addObject:@{@"controlsName":@"TableView+",@"describeName":@"空集的占位View",@"VCName":@"AxcEmptyDataVC"}];
        ...
        [Group2 addObject:@{@"controlsName":@"BarCode",@"describeName":@"二维码扫描",@"VCName":@"WLBarcodeViewController"}];
        ...
        [Group3 addObject:@{@"controlsName":@"多类型选择",@"describeName":@"城市、字符串等选择器",@"VCName":@"CRPickerViewController"}];
        
        [Group3 addObject:@{@"controlsName":@"设置字体",@"describeName":@"仿微信设置字体大小",@"VCName":@"IMSetFontSizeViewController"}];
         [Group3 addObject:@{@"controlsName":@"微信红包",@"describeName":@"仿微信设红包弹出",@"VCName":@"WXRedPacketViewController"}];
        
        [Group3 addObject:@{@"controlsName":@"截长图",@"describeName":@"截取长图",@"VCName":@"SnapshotScrollViewVC"}];
        
        [Group3 addObject:@{@"controlsName":@"雷达扫描",@"describeName":@"脉冲雷达扫描",@"VCName":@"RadarViewController"}];
        
        [Group3 addObject:@{@"controlsName":@"滑动悬浮按钮",@"describeName":@"全局滑动按钮",@"VCName":@"WMDragViewController"}];
        
        [Group3 addObject:@{@"controlsName":@"系统权限访问",@"describeName":@"主动请求各种系统权限",@"VCName":@"PrivacyPermissionViewVC"}];
        
         [Group3 addObject:@{@"controlsName":@"日历选择",@"describeName":@"弹框选择日期",@"VCName":@"CalendarPickerViewController"}];
        
        NSMutableArray *Group4 = [NSMutableArray array];
        [Group4 addObject:@{@"controlsName":@"图片",@"describeName":@"图片添加水印",@"VCName":@"PictureWatermarkVC"}];
         [Group4 addObject:@{@"controlsName":@"图片水印",@"describeName":@"添加文字与图片水印",@"VCName":@"WaterMarkViewController"}];
        
         [Group4 addObject:@{@"controlsName":@"滑动验证码",@"describeName":@"滑动获取验证码",@"VCName":@"SlideVerifyViewController"}];
        
        [Group4 addObject:@{@"controlsName":@"输入验证码",@"describeName":@"输入验证码方式",@"VCName":@"CaptchainputViewController"}];
...
- (NSArray *)sectionTitleArray{
    if (!_sectionTitleArray) {
        _sectionTitleArray = @[@"扩展类",@"控件类",@"其他框架之外的示例",@"图片处理相关"];
    }
